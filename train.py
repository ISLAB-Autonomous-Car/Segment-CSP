...
def train( backend = 'resnet18', snapshot = None, crop_x = 256, crop_y = 256, batch_size = 4, alpha= 1, epochs= 100, 
          start_lr= 0.001, milestones = '10,20,30', gpu = 'cuda:0'):
...
#     os.makedirs(models_path, exist_ok=True)
    ...
    for epoch in range(epochs):
        ...
        torch.save(net.state_dict(), "/model/"+str(epoch)+str(loss.item())+".pth")
